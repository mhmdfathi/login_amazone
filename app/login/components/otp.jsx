...
export default function Otp({
  ...
  const sendCodeAndSaveUser = async (email) => {
    if (otpType === "veriftEmail") {
      await fetch("http://localhost:4000/api/user/sendOtp", {
        method: "POST",
        headers: {
      ...
      await fetch("http://localhost:4000/api/user/sendOtpPassword", {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
        },
  ...
  const handelClick = async () => {
    ...
    if (otpType === "veriftEmail") {
      await fetch("http://localhost:4000/api/user/verifyEmail", {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
        },
      ...
      await fetch("http://localhost:4000/api/user/checkCodePass", {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
        },
